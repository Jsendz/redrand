...
export default function Home() {
  return (
    <div className="w-full h-screen flex flex-col justify-center  items-center bg-gradient-to-tr from-slate-50 via-gray-200 to-red-300 text-slate-700 bg-no-repeat bg-cover animate-slidein pt-10 ">
  ...
  emprendedora. Como no somos vendedores de motos, suponemos que será la segunda
