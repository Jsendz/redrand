...
export default function Nosotros() {
    return (
        <div className="w-full h-full  flex flex-col justify-center items-center p-5 bg-gradient-to-tr from-slate-50 via-gray-200 to-red-200 text-slate-700  pt-20 animate-slidein">
            <p className="text-2xl font-semibold pb-5 ">Si te gustan los gatos, estás a un <Link href="/gatitos"> <span className="font-bold animate-bounce text-pink-300">clic </span> </Link> de amarlos aún más. </p>
                <p className="pb-10 font-semibold text-xl" >{' '}

Vamos al grano. No somos una empresa gigante, no somos La Bresh, ni tampoco el ROW,
ni siquiera Lyrical Lemonade (aunque nos inspira mucho).</p> <p className="pb-10 font-semibold text-xl"> 
 Somos un colectivo creativo con
ganas de cambiar la corriente socio-cultural de un país entero. Nuestro país. ANDORRA. Y
hacemos cosas como <Link href="/nosotros/aftermovie"> <span className="font-bold animate-bounce text-pink-300">estas</span></Link>  (aftermovie).</p>
<p className="pb-10 font-semibold text-xl" >
...
<p className="pb-10 font-semibold text-xl" > (colar meme de monos
trabajando en un call-center), y vamos a transformar la escena del ocio en Andorra hasta
que no la reconozca ni el Yeti.</p>

<p className="pb-10 font-semibold text-xl">Nos gusta hacer las cosas diferente, a nuestra manera, un poco así (colar meme de monos
trabajando en un call-center), y vamos a transformar la escena del ocio en Andorra hasta
